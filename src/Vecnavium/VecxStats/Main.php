...
use Vecnavium\VecxStats\Commands\StatsCommand;
use Vecnavium\VecxStats\Provider\UserDataSessionProvider;
use Vecnavium\VecxStats\Provider\YamlDataProvider;
...
class Main extends PluginBase implements Listener
{
	...
	public function onEnable(): void
	{
		...
		$this->getServer()->getCommandMap()->register("VecxStats", new StatsCommand($this));
